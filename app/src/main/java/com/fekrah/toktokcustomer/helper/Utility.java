...
package com.fekrah.toktokcustomer.helper;
...
public class Utility {
    ...
    public static void showProgressDialog(Dialog dialog,boolean state) {
        dialog.setContentView(R.layout.layout_simple_progress_dialog);
        if (state){
            dialog.show();
        }else {
            dialog.dismiss();
